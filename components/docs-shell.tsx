...
export function DocsShell({ eyebrow, title, description, children }: { eyebrow: string; title: string; description: string; children: ReactNode }) {
  return <main className="docs-page">
    ...
    <div className="docs-wrap"><aside className="docs-sidebar" aria-label="Documentation sections"><strong>Start</strong><a href="/docs/quickstart">Quickstart</a><strong>Understand</strong><a href="/docs/concepts/human-agent-boundary">Human–agent boundary</a><strong>Reference</strong><a href="/docs/reference/webmcp-tools">WebMCP tools</a><a href="/docs/reference/proof-format">Proof format</a><a href="/docs/reference/error-codes">Error codes</a><strong>Apply</strong><a href="/use-cases">Use cases</a><a href="/blog">Essays</a></aside>

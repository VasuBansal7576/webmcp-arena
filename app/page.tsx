  ...
  return (
    <main>
      ...
      <section className="workbench" aria-labelledby="proof-title">
        ...
        <p className="section-copy">An agent may prepare and poll this vendor-neutral release audit through WebMCP. Approval must traverse the visible interface with a one-time capability bound to the release, claimed agent, tool definition, exact arguments, target, contract, browser session, nonce, and expiry. The demo agent label is self-asserted, not vendor-attested. This signed proof measures Arena&apos;s owned server adapter through terminal settlement; the separate <a href="/checkout?mode=vulnerable">native WebMCP checkout target</a> is an interactive standards demo, not substituted evidence.</p>
